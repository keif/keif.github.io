...
pubDatetime: 2025-09-17T00:00:00.000Z
modDatetime: 2025-12-18T16:55:49.053Z
...
Recently, I added this in a Next.js project by pulling the **file's modified date** directly from the filesystem using Node's built-in `fs` module. In this scenario, it was important for one particular file to have the "date published" match the date the change is made/goes live - which in my case is usually the same day it's handed to me.
...
This simple utility works great _as-is_ for my specific use-case, but there are a few ways to extend or refine it:
