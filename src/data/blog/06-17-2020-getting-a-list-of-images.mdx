...
author: Keith Baker
pubDatetime: 2020-06-17T00:00:00.000Z
modDatetime: 2026-06-15T08:26:33.903Z
slug: getting-a-list-of-images
draft: false
tags:
    - wget
    - automation
    - bash
    - csv
description: Learn how to use wget and parallel to download thousands of images from a URL list, with setup instructions and syntax examples for macOS.
